	...
	private static void gamsi(int index) {
		...
		case '1':
			for(int d =0; d<4; d++) {
				...
				count = tempCount;
				//zzing(cctvs.get(index).y, cctvs.get(index).x, d, '0');
			}
			break;
		case '2':
			for(int d =0; d<2; d++) {
				...
				count = tempCount;
				//zzing(cctvs.get(index).y, cctvs.get(index).x, d, '0');
				//zzing(cctvs.get(index).y, cctvs.get(index).x, d+2, '0');
			}
			break;
		case '3':
			for(int d =0; d<4; d++) {
				...
				count = tempCount;
				//zzing(cctvs.get(index).y, cctvs.get(index).x, d, '0');
				//zzing(cctvs.get(index).y, cctvs.get(index).x, (d+1)%4, '0');
			}
			break;
		case '4':
			for(int d =0; d<4; d++) {
				...
				//zzing(cctvs.get(index).y, cctvs.get(index).x, d, '0');
				//zzing(cctvs.get(index).y, cctvs.get(index).x, (d+1)%4, '0');
				//zzing(cctvs.get(index).y, cctvs.get(index).x, (d+2)%4, '0');
			}
			break;
		default:
			break;
